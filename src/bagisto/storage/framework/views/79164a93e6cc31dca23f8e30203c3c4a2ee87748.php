    ...
    <script type="text/x-template" id="logo-template">
        <a
            ...
            <?php if($logo = core()->getCurrentChannel()->logo_url): ?>
                <img class="logo" src="<?php echo e($logo); ?>" alt="" width="200" height="50" />
            <?php else: ?>
                <img class="logo" src="<?php echo e(asset('themes/velocity/assets/images/logo-text.png')); ?>" alt="" width="200" height="50" />
            <?php endif; ?>
        </a>
    </script>
...
<?php $__env->stopPush(); ?><?php /**PATH /var/www/html/bagisto/resources/themes/velocity/views/UI/particals.blade.php ENDPATH**/ ?>