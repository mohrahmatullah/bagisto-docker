    ...
    <script type="text/x-template" id="product-image-item-template">
        <label class="image-item" v-bind:class="{ 'has-image': imageData.length > 0 }">
            ...
            <label class="remove-image" @click="removeImage()">
                <?php echo e(__('admin::app.catalog.products.remove-image-btn-title')); ?>
...
<?php $__env->stopPush(); ?><?php /**PATH /var/www/html/bagisto/packages/Webkul/Admin/src/Providers/../Resources/views/catalog/products/accordians/images.blade.php ENDPATH**/ ?>