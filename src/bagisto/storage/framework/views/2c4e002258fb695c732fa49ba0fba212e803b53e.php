            ...
            <div class="vc-small-screen container">
                <div class="row">
                                        ...
                                        <?php if($locale): ?>
                                            <div class="language-logo-wrapper">
                                                <?php if($locale->locale_image): ?>
                                                    <img
                                                        class="language-logo"
                                                        src="<?php echo e(asset('/storage/' . $locale->locale_image)); ?>" alt="" />
                                                <?php elseif($locale->code == "en"): ?>
                                                    <img
                                                        class="language-logo"
                                                        src="<?php echo e(asset('/themes/velocity/assets/images/flags/en.png')); ?>" alt="" />
                                                <?php endif; ?>
                                            </div>
                                            ...
                                            <a
                                                ...
                                                <?php if( $locale->code == 'en'): ?>
                                                    <div class="category-logo">
                                                        <img
                                                        class="category-icon"
                                                        src="<?php echo e(asset('/themes/velocity/assets/images/flags/en.png')); ?>" alt="" width="20" height="20" />
                                                    </div>
                                                <?php else: ?>
                                                    ...
                                                    <div class="category-logo">
                                                        <img
                                                        class="category-icon"
                                                        src="<?php echo e(asset('/storage/' . $locale->locale_image)); ?>" alt="" width="20" height="20" />
                                                    </div>
                                                <?php endif; ?>
                    ...
                    <div class="right-vc-header col-6">
                        ...
                        <?php if($showWishlist): ?>
                            <a class="wishlist-btn unset" :href="`<?php echo e(route('customer.wishlist.index')); ?>`">
...
<?php $__env->stopPush(); ?><?php /**PATH /var/www/html/bagisto/resources/themes/velocity/views/UI/header.blade.php ENDPATH**/ ?>