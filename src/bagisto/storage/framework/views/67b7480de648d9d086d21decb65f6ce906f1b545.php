            ...
            <td>
                ...
                <div class="control-group">
                    <div class="control-group" :class="[errors.has(inputName + '[value]') ? 'has-error' : '']">
                        <input type="number" step=".01" v-validate="{required: true, min_value: 0, ...(customerGroupPrice.value_type === 'discount' ? {max_value: 100} : {})}" :name="[inputName + '[value]']" v-model="customerGroupPrice.value" class="control" data-vv-as="&quot;<?php echo e(__('admin::app.datagrid.price')); ?>&quot;"/>
...
<?php $__env->stopPush(); ?>
<?php /**PATH /var/www/html/bagisto/packages/Webkul/Admin/src/Providers/../Resources/views/catalog/products/accordians/customer-group-price.blade.php ENDPATH**/ ?>